...
export const RegistrationFormConsole = ({ className }: TRegistrationForm) => {
  ...
  if (isCompleted) return <RegCompleted game="efconsole" />
      ...
      <div className="flex place-items-center justify-around gap-4">
        <h2 className="mt-20 text-center text-3xl leading-7 font-bold uppercase sm:text-4xl sm:leading-8 lg:text-5xl lg:leading-11">
          ...
          <span className="text-primary font-extrabold">
            {games.efconsole.maxRegistration}
          </span>
        </h2>
        <div className="flex flex-col">
          ...
          <GameCard
            logo={games.efconsole.logo}
            name={games.efconsole.name}
            image={games.efconsole.image}
            charecterName={games.efconsole.charecterName}
            className="from-primary/50 bg-gradient-to-t"
            logoClassName={games.efconsole.logoClassName}
          />
        </div>
        <h2 className="mt-20 text-center text-3xl leading-7 font-bold uppercase sm:text-4xl sm:leading-8 lg:text-5xl lg:leading-11">
          LEFT
